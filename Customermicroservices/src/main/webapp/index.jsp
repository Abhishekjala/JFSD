   ...
   <header>
      <div class="header-container">
         <nav class="header-nav-bar">
				...
				<ul class="header-nav-lists">
						...
						<li class="header-nav-list">
						<a class="header-nav-link header-active" href="/admin/adminlogin">Admin</a>
					</li>
					<li class="header-nav-list">
						<a class="header-nav-link header-active" href="/manager/managerLogin">Manager</a>
					</li>
					<li class="header-nav-list">
						<a class="header-nav-link header-active" href="custlogin">Login</a>
					</li>
						<li class="header-nav-list"><a class="header-btn header-btn-custom" href="custreg">REGISTER NOW</a></li>
					</ul>
	...
	<div class="jumbotron-container">
		<div class="jumbotron-left">
			...
			<p>We are focused on providing clients with the highest level<br>
					...
					<a href="custreg" class="btn btn-fill btn-large">Register Now</a>
		</div>
	</div>
	...
	<div class="review-container">
		...
		<div class="cards-container">
				<div class="card">
					<img src="./assets/img/customer1.jpg" alt="" class="card-avi">
					<h2 class="card-title">
							Goutam Again
					</h2>
				...
				<div class="card">
					<img src="./assets/img/customer2.jpg" alt="" class="card-avi">
					<h2 class="card-title">
							Vardhan Reddy
					</h2>
					<h3 class="card-subtitle">
